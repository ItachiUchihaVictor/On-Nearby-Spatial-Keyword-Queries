...
private:
	...
	void getPointsRightHalf(node_d *v_node, point &p, point &p0, point &p1, int &flag); 
	void getPointsLeftHalf(node_d *v_node, point &q, point &q0, point &q1, int &flag);
	...
	int bridgeCasesRcHull(const point &p, const point &p0, const point &p1,
					const point &q, const point &q0, const point &q1,
					const double &half, const int &flag_lh, const int &flag_uh) const;
	node_d *newSSLhLeft(node_d *current, point &q, point &q0, point &q1, bool &onepoint);
	node_d *newSSUhRight(node_d *current, point &p, point &p0, point &p1, bool &onepoint);
	node_d *newSSLhRight(node_d *current, point &q, point &q0, point &q1, bool &onepoint, bool &out);
	node_d *newSSUhLeft(node_d *current, point &p, point &p0, point &p1, bool &onepoint, bool &out);
